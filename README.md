...
Version 0.11.1 adds a MusicBrainz ISRC fallback for composer metadata when SongRec/Shazam metadata does not provide composer or writer fields.
...
- Long metadata text stays clipped to the metadata panel width, pauses briefly at the beginning, then scrolls left until the full text has been visible.
...
git tag -a v0.11.1 -m "songart 0.11.1"
